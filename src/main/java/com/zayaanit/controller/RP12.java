...
@Controller
@RequestMapping("/RP12")
public class RP12 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP12"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP12"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP12");
		} catch (Exception e) {
