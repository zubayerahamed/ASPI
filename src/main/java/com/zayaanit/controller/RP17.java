...
@Controller
@RequestMapping("/RP17")
public class RP17 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP17"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP17"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP17");
		} catch (Exception e) {
