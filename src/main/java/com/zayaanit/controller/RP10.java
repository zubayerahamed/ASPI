...
@Controller
@RequestMapping("/RP10")
public class RP10 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP10"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP10"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP10");
		} catch (Exception e) {
