...
@Controller
@RequestMapping("/RP03")
public class RP03 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP03"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP03"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP03");
		} catch (Exception e) {
