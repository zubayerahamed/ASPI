...
@Controller
@RequestMapping("/RP02")
public class RP02 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP02"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP02"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP02");
		} catch (Exception e) {
