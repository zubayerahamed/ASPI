...
public class IM11 extends KitController {
	...
	public @ResponseBody Map<String, Object> store(Opordheader opordheader, BindingResult bindingResult){
		...
		if(SubmitFor.INSERT.equals(opordheader.getSubmitFor())) {
			...
			opordheader.setXordernum(xscreenRepo.Fn_getTrn(sessionManager.getBusinessId(), "IM11"));
			opordheader.setZid(sessionManager.getBusinessId());
			opordheader = opordheaderRepo.save(opordheader);

			List<ReloadSection> reloadSections = new ArrayList<>();
			reloadSections.add(new ReloadSection("main-form-container", "/IM11?xordernum=" + opordheader.getXordernum()));
			reloadSections.add(new ReloadSection("detail-table-container", "/IM11/detail-table?xordernum="+ opordheader.getXordernum() +"&xrow=RESET"));
		...
		List<ReloadSection> reloadSections = new ArrayList<>();
		reloadSections.add(new ReloadSection("main-form-container", "/IM11?xordernum=" + existObj.getXordernum()));
		reloadSections.add(new ReloadSection("detail-table-container", "/IM11/detail-table?xordernum="+ opordheader.getXordernum() +"&xrow=RESET"));
		reloadSections.add(new ReloadSection("list-table-container", "/IM11/list-table"));
		responseHelper.setReloadSections(reloadSections);
	...
	public @ResponseBody Map<String, Object> storeDetail(Oporddetail oporddetail, BindingResult bindingResult){
		...
		if(SubmitFor.INSERT.equals(oporddetail.getSubmitFor())) {
			...
			List<ReloadSection> reloadSections = new ArrayList<>();
			reloadSections.add(new ReloadSection("main-form-container", "/IM11?xordernum=" + oporddetail.getXordernum()));
			reloadSections.add(new ReloadSection("detail-table-container", "/IM11/detail-table?xordernum=" + oporddetail.getXordernum() + "&xrow=RESET"));
			reloadSections.add(new ReloadSection("list-table-container", "/IM11/list-table"));
			responseHelper.setReloadSections(reloadSections);
...
//		List<ReloadSection> reloadSections = new ArrayList<>();
//		reloadSections.add(new ReloadSection("main-form-container", "/IM11?xordernum=" + oporddetail.getXordernum()));
//		reloadSections.add(new ReloadSection("detail-table-container", "/IM11/detail-table?xordernum=" + oporddetail.getXordernum() + "&xrow=" + exist.getXrow()));
//		reloadSections.add(new ReloadSection("list-table-container", "/IM11/list-table"));
//		responseHelper.setReloadSections(reloadSections);
...
//		return responseHelper.getResponse();
	...
	public @ResponseBody Map<String, Object> delete(@RequestParam Integer xordernum){
		...
		List<ReloadSection> reloadSections = new ArrayList<>();
		reloadSections.add(new ReloadSection("main-form-container", "/IM11?xordernum=RESET"));
		reloadSections.add(new ReloadSection("detail-table-container", "/IM11/detail-table?xordernum=RESET&xrow=RESET"));
		reloadSections.add(new ReloadSection("list-table-container", "/IM11/list-table"));
		responseHelper.setReloadSections(reloadSections);
	...
	public @ResponseBody Map<String, Object> deleteDetail(@RequestParam Integer xordernum, @RequestParam Integer xrow) throws Exception{
		...
		List<ReloadSection> reloadSections = new ArrayList<>();
		reloadSections.add(new ReloadSection("main-form-container", "/IM11?xordernum=" + xordernum));
		reloadSections.add(new ReloadSection("detail-table-container", "/IM11/detail-table?xordernum="+xordernum+"&xrow=RESET"));
		reloadSections.add(new ReloadSection("list-table-container", "/IM11/list-table"));
		responseHelper.setReloadSections(reloadSections);
		responseHelper.setSuccessStatusAndMessage("Deleted successfully");
		return responseHelper.getResponse();
