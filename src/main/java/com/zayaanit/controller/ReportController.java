 ...
 */
@Slf4j
public abstract class ReportController extends KitController {
...
//		String reportName = appConfig.getReportTemplatepath() + "/" + rm.getFileName();
...
//		if(StringUtils.isBlank(reportName) || !fileExist(reportName)) reportName = appConfig.getReportTemplatepath().concat("/").concat(rm.getFileName());
