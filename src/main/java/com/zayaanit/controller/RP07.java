...
@Controller
@RequestMapping("/RP07")
public class RP07 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP07"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP07"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP07");
		} catch (Exception e) {
