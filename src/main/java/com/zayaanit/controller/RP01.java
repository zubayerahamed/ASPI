...
@Controller
@RequestMapping("/RP01")
public class RP01 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP01"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP01"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP01");
		} catch (Exception e) {
