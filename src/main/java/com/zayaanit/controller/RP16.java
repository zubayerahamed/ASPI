...
@Controller
@RequestMapping("/RP16")
public class RP16 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP16"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP16"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP16");
		} catch (Exception e) {
