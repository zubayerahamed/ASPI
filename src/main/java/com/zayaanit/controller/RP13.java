...
@Controller
@RequestMapping("/RP13")
public class RP13 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP13"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP13"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP13");
		} catch (Exception e) {
