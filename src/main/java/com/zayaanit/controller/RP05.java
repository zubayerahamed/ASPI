...
@Controller
@RequestMapping("/RP05")
public class RP05 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP05"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP05"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP05");
		} catch (Exception e) {
