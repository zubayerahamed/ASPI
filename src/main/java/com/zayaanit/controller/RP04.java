...
@Controller
@RequestMapping("/RP04")
public class RP04 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP04"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP04"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP04");
		} catch (Exception e) {
