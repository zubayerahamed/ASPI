...
@Controller
@RequestMapping("/RP09")
public class RP09 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP09"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP09"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP09");
		} catch (Exception e) {
