...
@Controller
@RequestMapping("/RP08")
public class RP08 extends ReportController{
	...
	protected String pageTitle() {
		...
		Optional<Xscreens> op = xscreenRepo.findById(new XscreensPK(sessionManager.getBusinessId(), "RP08"));
	...
	public String index(HttpServletRequest request, Model model) {
		model.addAttribute("reports", getReports("RP08"));

		ReportMenu rm = null;
		try {
			rm = ReportMenu.valueOf("RP08");
		} catch (Exception e) {
