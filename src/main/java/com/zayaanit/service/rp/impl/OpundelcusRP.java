...
@Service("opundelcus_Service")
public class OpundelcusRP extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(6, "Sales Area", "/search/table/LMD16/0?hint=", "", true));
