...
@Service("imledsmmisrp17_Service")
public class ImledsmmisRP17 extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateSelect2(4, "Store Category", storeCategoryOp, "", false));
		...
		fieldsList.add(FormFieldBuilder.generateSelect2(6, "Item Group", xgroupOp, "", false));
		...
		fieldsList.add(FormFieldBuilder.generateSelect2(7, "Item Category", xcatitemOp, "", false));
		...
		fieldsList.add(FormFieldBuilder.generateSelect2(8, "Sub Category", xsubcatOp, "", false));
