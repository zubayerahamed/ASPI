...
@Service("imrcvdtrp17_Service")
public class ImrcvdtRP17 extends AbstractReportService {
...
//		fieldsList.add(FormFieldBuilder.generateDropdownField(4, "Store Category", storeCategoryOp, "", false));
		...
		List<Xcodes> receiveTypes = xcodesRepo.findAllByXtypeAndZid("IM Receive Type", sessionManager.getBusinessId());
		...
		fieldsList.add(FormFieldBuilder.generateDropdownField(6, "Receive Type", receiveTypeOp, "", false));
		...
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(9, "Receive ID", "/search/table/LIM12/0?hint=", "", false));
