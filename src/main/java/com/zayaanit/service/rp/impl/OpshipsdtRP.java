...
@Service("opshipsdt_Service")
public class OpshipsdtRP extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(5, "Shipment No", "/search/table/LSP11/0?hint=", "", false));
