...
@Service("imleddtrp17_Service")
public class ImleddtRP17 extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(4, "Store", "/search/table/LMD1101/0?hint=", "", true));
