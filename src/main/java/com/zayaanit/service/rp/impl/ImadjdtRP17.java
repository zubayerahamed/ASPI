...
@Service("imadjdtrp17_Service")
public class ImadjdtRP17 extends AbstractReportService {
...
//		fieldsList.add(FormFieldBuilder.generateDropdownField(4, "Store Category", storeCategoryOp, "", false));
		...
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(8, "Adjustment ID", "/search/table/LIM14/0?hint=", "", false));
