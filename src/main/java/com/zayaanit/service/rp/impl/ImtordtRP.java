...
@Service("imtordt_Service")
public class ImtordtRP extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(4, "From Store", "/search/table/LMD11/0?hint=", "", false));
		
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(5, "To Store", "/search/table/LMD11/0?hint=", "", false));
