...
@Service("oporddtff_Service")
public class OporddtffRP extends AbstractReportService {
	...
	public List getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(9, "Order ID", "/search/table/LSO14/0?hint=", "", false));
