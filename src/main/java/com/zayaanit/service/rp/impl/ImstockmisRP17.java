...
@Service("imstockmisrp17_Service")
public class ImstockmisRP17 extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateDropdownField(2, "Store Category", storeCategoryOp, "", false));
