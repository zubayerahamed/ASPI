...
@Service("arleddt16_Service")
public class Arleddt16RP extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		// Param 4 xcus
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(4, "Customer", "/search/table/LMD14/2?hint=", "", true));
