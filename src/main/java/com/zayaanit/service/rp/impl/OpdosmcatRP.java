...
@Service("opdosmcat_Service")
public class OpdosmcatRP extends AbstractReportService {
	...
	public List getReportFields() {
		...
		List<Xcodes> itemCategories = xcodesRepo.findAllByXtypeAndZid("Item Group", sessionManager.getBusinessId());
		...
		fieldsList.add(FormFieldBuilder.generateDropdownField(7, "Item Group", xcatitemOp, "", false));
