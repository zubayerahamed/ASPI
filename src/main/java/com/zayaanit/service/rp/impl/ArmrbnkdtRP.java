...
@Service("armrbnkdt_Service")
public class ArmrbnkdtRP extends AbstractReportService {
	...
	public List getReportFields() {
		...
		// Param 6 xstatus
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(7, "Employee", "/search/table/LMD12/0?hint=", "", false));
		...
		fieldsList.add(FormFieldBuilder.generateDropdownField(8, "Status", outletOptions, "", true));
