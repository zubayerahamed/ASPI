...
@Service("opdodtmis_Service")
public class OpdodtmisRP extends AbstractReportService {
	...
	public List<FormFieldBuilder> getReportFields() {
		...
		fieldsList.add(FormFieldBuilder.generateAdvancedSearchField(9, "Invoice ID", "/search/table/LSO17/0?hint=", "", false));
